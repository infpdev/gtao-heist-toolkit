...
; ⏐==========================================================================================================⏐
{
    ...
    UpdateGlobalStatus(isHacking, isTimingOut := false, timeoutProgress := 0, caller := "", force := false, *) {
        ...
        ledgeGrabText := ledgeGrabEnabled ? "`nPress " readableLedgeGrabKey " to " (ledgeGrabInProgress ? "stop" :
            "initiate") " Ledge Grab" : ""
        ...
        if (!scriptsEnabled) {
            status := "Scripts disabled`n" noSaveText . ledgeGrabText
            earlyReturn := true
        ...
        aggregatedStatus := unsupportedResolutionText . hackStatus "`n" noSaveText . ledgeGrabText "`n" keys
