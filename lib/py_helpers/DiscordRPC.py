...
class VaultOpsPresence:
    ...
    def show_fingerprint_presence(self):
        ...
        self._update(
            details="sudo ./lester.sh --fingerprint",
    ...
    def show_ledge_grab_presence(self):
        ...
        self._update(
            details="sudo ./lester.sh --ledge-grab",
