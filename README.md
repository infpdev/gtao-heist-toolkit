...
> https://www.virustotal.com/gui/file/74a070ca64f77322312fe2c93f50388aaf0ac03df6fac3bf3bc89c53b79fc608
...
So NO. Don't use the new method right away. Finish / replay some other heist, AS A HOST, using the new method before you replay Cayo Perico again. Otherwise, you'll 100% lose the heist and end up in the comments section asking why it didn't work.
...
- Clicking <img src="lib/static/exit.png" width="13" alt="Exit Button"> immediately disables **NoSave**, terminates the app, and stops all running scripts.
- Clicking <img src="lib/static/minimize.png" width="13" alt="Minimize Button"> minimizes the app to the taskbar.
- Using the <img src="lib/static/drag.png" width="13" alt="Drag Button"> button:
